...
public class ServoServlet implements PublicWSProviderWithParams, ManagedRunnable{
	...
	public ServoServlet (BundleContext c, IPositionProvider ipos){
		...
		if (operation == PublicWSProvider2.GET) {
			return new IWSResponse() {
				public Object getContent() {
					...
					temp =  pos.getLatitudeLongitude();
					if (temp != null) {
						System.out.println("latitude: " + temp.latitude);
						System.out.println("longtitude: " + temp.longitude);
					}
					else System.out.println("panda");
